...
2.  **all `.feature` Files:**
    *   Descriptions (Feature/Scenario) align with `CABINET.yaml`. (Note: This description is intentionally duplicated for tooling/readability; alignment ensures consistency).
